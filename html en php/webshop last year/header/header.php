                            ...
                            <form action="HomePage.php" id="popForm" method="POST">
                                <div>
                                    ...
                                    {?>
                                        ...
                                        <a href="reparaties.php"> <button style="margin:5px 5px 5px 5px; width:150px;" type="button" class="btn btn-primary">Reparaties</button></a>
                                    <?php }  ?>
                                </div>
                            </form>
                        </div>
                ...
                <div id="mand" class="hide">
                    <form action="/echo/html/" id="popForm" method="get">
                        <div>
                            ...
                            <a href="Bevestiging(test).php"> <button style="width: 100px;" type="button">Afrekenen</button></a>
                        </div>
                    </form>
                </div>
            ...
            <div id="catbalk">
                ...
                <div id="catlist">
                    <ul class="horizontallist">
                        ...
                        <a href="reparatie.php"> <button> Reparatie </button></a>
